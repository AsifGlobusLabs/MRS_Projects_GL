...
const RegistrationForm = () => {
  ...
  //       // body: JSON.stringify({first_name, last_name, address, city, state, phone_number,  email, position, employee_id, password, confirm_password, fd  }),
  //     });
  ...
  return (
    <div className="main-container p-0">
      ...
      <div className="register">
        ...
        <input type="file" id="myFile" name="filename" accept="image/*" onChange={(e)=>{setFile(e.target.files)}}/>
